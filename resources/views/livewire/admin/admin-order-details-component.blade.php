    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            <div class="row g-3 mb-4 align-items-center justify-content-between">
                <div class="col-auto">
                    <a class="action-link" href="{{ route('admin.orders') }}"><i class="fas fa-arrow-left"></i> Commandes
                    </a>
                </div>
                <div>
                                            ...
                                            <div class="app-card-body px-4 w-100">
                                                <div class="row">
                                                    <div class="item border-bottom py-3 col-md-6 border-md-end">
                                                        <div class="row justify-content-between align-items-center">
                                                            <div class="col-auto">
                                                                <div class="item-label"><strong>First name </strong>
                                                                </div>
                                                                <div class="item-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="item border-bottom py-3 col-md-6">
                                                        <div class="row justify-content-between align-items-center">
                                                            <div class="col-auto">
                                                                <div class="item-label"><strong>Email</strong></div>
                                                                <div class="item-data">{{ $order->shipping->email }}
                                                                </div>
                                                            </div>
                                                            <!--//col-->
                                                ...
                                                <div class="row">
                                                    <div class="item border-bottom py-3 col-md-6 border-md-end">
                                                        <div class="row justify-content-between align-items-center">
                                                            <div class="col-auto">
                                                                <div class="item-label"><strong>Line 1 </strong></div>
                                                                <div class="item-data">{{ $order->shipping->line1 }}
                                                                </div>
                                                            </div>
                                                            <!--//col-->
                                ...
                                <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                                    ...
                                    <div class="app-card-body px-4 w-100">
                                        ...
                                        <div class="item border-bottom py-3">
                                            <div class="row justify-content-between align-items-center">
                                                <div class="col-auto">
                                                    <div class="item-label text-capitalize "><strong>status </strong>
                                                    </div>
                                                    <div class="item-data">
                                                        @if ($order->transition)
                                                            <span
