                                                ...
                                                <header class="d-lg-flex">
                                                    <div class="flex-grow-1 mt-2">
                                                        ...
                                                        <span class="text-muted">Date:
                                                            {{ Carbon\Carbon::parse($order->created_at)->format('d F Y') }}</span>
                                                    </div>
                                                </header>
                                            </div>
                                            <!--//row-->
                                                        ...
                                                        <div class="item border-bottom py-3 col-md-6">
                                                            <a href="{{ route('product.details', ['slug' => $item->product->slug]) }}"
                                                                ...
                                                                <figure class="itemside mb-3">
                                                                    <div class="aside">
                                                                        <b
                                                                            class="badge bg-secondary rounded-pill">{{ $item->quantity }}x</b>
                                                                    ...
                                                                    <figcaption class="info">
                                                                        <p class="item-label">
                                                                            {{ $item->product->name }}</p>
                                                                        <p class="item-label"><strong> Montant :
                                                                                {{ $item->price }} MAD </strong></p>
                                                                        <strong> Total :
                                                ...
                                                <div class="item border-bottom py-3">
                                                    <div class="row justify-content-between align-items-center">
                                                        <div class="col-auto">
                                                            ...
                                                            <div class="item-data">{{ $order->zipcode ?? '---' }}
                                                            </div>
                                                        </div>
                                                        <!--//col-->
                                        ...
                                        <div
                                            ...
                                            <div class="app-card-header p-3 border-bottom-0">
                                                <div class="row align-items-center gx-3">
                                                    ...
                                                    <!--//col-->
                                                    <div class="col-auto">
                                                        <h4 class="app-card-title text-capitalize">Shipping Details
                                                        </h4>
                                                    </div>
                                                    <!--//col-->
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="item border-bottom py-3 col-md-6 border-md-end">
                                                            <div
                                                                ...
                                                                <div class="col-auto">
                                                                    <div class="item-label"><strong>First name
                                                                        </strong></div>
                                                                    <div class="item-data">
                                                                        {{ $order->shipping->firstname }}</div>
                                                                </div>
                                                                <!--//col-->
                                                            </div>
                                                            <!--//row-->
                                                        ...
                                                        <div class="item border-bottom py-3 col-md-6">
                                                            <div
                                                                class="row justify-content-between align-items-center">
                                                                <div class="col-auto">
                                                                    <div class="item-label"><strong>Last name</strong>
                                                                    </div>
                                                                    <div class="item-data">
                                                                        {{ $order->shipping->lastname }}</div>
                                                                </div>
                                                                <!--//col-->
                                                            </div>
                                                            <!--//row-->
                                                    ...
                                                    <div class="row">
                                                        <div class="item border-bottom py-3 col-md-6 border-md-end">
                                                            <div
                                                                class="row justify-content-between align-items-center">
                                                                <div class="col-auto">
                                                                    <div class="item-label"><strong>Phone </strong>
                                                                    </div>
                                                                    <div class="item-data">
                                                                        {{ $order->shipping->mobile }}</div>
                                                                </div>
                                                                <!--//col-->
                                                        ...
                                                        <div class="item border-bottom py-3 col-md-6">
                                                            <div
                                                                class="row justify-content-between align-items-center">
                                                                <div class="col-auto">
                                                                    <div class="item-label"><strong>Email</strong>
                                                                    </div>
                                                                    <div class="item-data">
                                                                        {{ $order->shipping->email }}</div>
                                                                </div>
                                                                <!--//col-->
                                                    ...
                                                    <div class="row">
                                                        <div class="item border-bottom py-3 col-md-6 border-md-end">
                                                            <div
                                                                class="row justify-content-between align-items-center">
                                                                <div class="col-auto">
                                                                    <div class="item-label"><strong>Line 1 </strong>
                                                                    </div>
                                                                    <div class="item-data">
                                                                        {{ $order->shipping->line1 }}</div>
                                                                </div>
                                                                <!--//col-->
                                                        ...
                                                        <div class="item border-bottom py-3 col-md-6">
                                                            <div
                                                                class="row justify-content-between align-items-center">
                                                                <div class="col-auto">
                                                                    <div class="item-label"><strong>Line 2</strong>
                                                                    </div>
                                                                    <div class="item-data">
                                                                        {{ $order->shipping->line2 ?? '---' }}</div>
                                                                </div>
                                                                <!--//col-->
                                                    ...
                                                    <div class="row">
                                                        <div class="item border-bottom py-3 col-md-6 border-md-end">
                                                            <div
                                                                class="row justify-content-between align-items-center">
                                                                <div class="col-auto">
                                                                    <div class="item-label"><strong>City </strong>
                                                                    </div>
                                                                    <div class="item-data">
                                                                        {{ $order->shipping->city ?? '---' }}</div>
                                                                </div>
                                                                <!--//col-->
                                                        ...
                                                        <div class="item border-bottom py-3 col-md-6">
                                                            <div
                                                                class="row justify-content-between align-items-center">
                                                                <div class="col-auto">
                                                                    <div class="item-label"><strong>Country</strong>
                                                                    </div>
                                                                    <div class="item-data">
                                                                        {{ $order->shipping->country }}</div>
                                                                </div>
                                                                <!--//col-->
                                                    ...
                                                    <div class="row">
                                                        <div class="item border-bottom py-3">
                                                            <div
                                                                class="row justify-content-between align-items-center">
                                                                <div class="col-auto">
                                                                    <div class="item-label"><strong>Zipcode</strong>
                                                                    </div>
                                                                    <div class="item-data">
                                                                        {{ $order->shipping->zipcode ?? '---' }}</div>
                                                                </div>
                                                                <!--//col-->
                                    ...
                                    <div
                                        ...
                                        <div class="app-card-body px-4 w-100">
                                            ...
                                            <div class="item border-bottom py-3">
                                                <div class="row justify-content-between align-items-center">
                                                    <div class="col-auto">
                                                        <div class="item-label text-capitalize "><strong>status
                                                            </strong></div>
                                                        <div class="item-data">
                                                            @if ($order->transition)
                                                                <span
                                                                    class="badge bg-success">{{ $order->transition->mode }}
                                                                @else
                                                                    ---
                                                            @endif
                                                        </div>
                                                ...
                                                <div class="row justify-content-between align-items-center">
                                                    <div class="col-auto">
                                                        <div class="item-label text-capitalize "><strong>transition
                                                                date</strong></div>
                                                        <div class="item-data">
                                                            {{ $order->transition->created_at ?? '---' }}</div>
                                                    </div>
                                                    <!--//col-->
                                                </div>
                                                <!--//row-->
