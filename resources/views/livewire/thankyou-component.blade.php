                    ...
                    <div class="card-body">
                        <div class="mt-4 mx-auto text-center" style="max-width:600px"> <svg width="96px" height="96px"
                            ...
                            <div class="my-3">
                                ...
                                <p>
                                    Commande #OD <br/>
                                    Vous allez bientôt recevoir un email de confirmation avec les détails de votre
                                    commande et le suivi de livraison.</p>
                                    <a class="btn btn-outline-primary" href="{{ route('shop') }}">Découvrir d’autres produits</a>
                            </div>
                        </div>
                ...
                <article class="card">
                    <div class="card-body">
                        ...
                        <div class="itemside mb-3">
                            ...
                            <div class="info lh-sm"> <strong>Order ID: 2313440</strong> <br> <span
                                    class="text-muted">Wed, Sept
                                    13, 2021</span> </div>
                        </div>
                        ...
                        <hr> <a href="#" class="btn btn-light">Download
                            invoice</a>
                    </div>
                </article>
                <!-- ============== COMPONENT RECEIPE .// =============== -->
