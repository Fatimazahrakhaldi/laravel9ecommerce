<footer class="section-footer bg-white shadow">
    <div class="container">
            ...
            <div class="row">
                ...
                <aside class="col-6 col-sm-3 col-lg-2">
                    ...
                    <ul class="list-menu mb-4">
                        <li> <a href="https://bootstrap-ecommerce.com/components.html#">About us</a></li>
                        <li> <a href="https://bootstrap-ecommerce.com/components.html#">Services</a></li>
                        <li> <a href="https://bootstrap-ecommerce.com/components.html#">Rules and terms</a></li>
                        <li> <a href="https://bootstrap-ecommerce.com/components.html#">Blogs</a></li>
                    </ul>
                </aside>
                <aside class="col-6 col-sm-3 col-lg-2">
                    <h6 class="title">Services</h6>
                    <ul class="list-menu mb-4">
                        <li> <a href="https://bootstrap-ecommerce.com/components.html#">Help center</a></li>
                        <li> <a href="https://bootstrap-ecommerce.com/components.html#">Money refund</a></li>
                        <li> <a href="https://bootstrap-ecommerce.com/components.html#">Terms and Policy</a></li>
                        <li> <a href="https://bootstrap-ecommerce.com/components.html#">Open dispute</a></li>
                    </ul>
                </aside>
                <aside class="col-6 col-sm-3 col-lg-2">
                    ...
                    <ul class="list-menu mb-4">
                        ...
                        <li> <a href="https://bootstrap-ecommerce.com/components.html#"> Account Setting </a></li>
                        <li> <a href="https://bootstrap-ecommerce.com/components.html#"> My Orders </a></li>
                    </ul>
                </aside>
        ...
        <section class="footer-bottom d-flex justify-content-lg-between border-top">
            ...
            <nav> <a href="https://bootstrap-ecommerce.com/components.html#" class="px-2">Support</a> <a href="https://bootstrap-ecommerce.com/components.html#" class="px-2">Privacy &amp; Cookies</a> <a href="https://bootstrap-ecommerce.com/components.html#"
                    class="px-2">Accessibility</a> </nav>
        </section>
    </div>
    <!-- container end.// -->
</footer>
