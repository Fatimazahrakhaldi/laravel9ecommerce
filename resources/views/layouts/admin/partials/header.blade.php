                        ...
                        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item"><a class="submenu-link"
                                        href="notifications.html">Gérer le Slider d'accueil</a></li>
                                <li class="submenu-item"><a class="submenu-link" href="account.html">Gérer des codes promo</a>
                                </li>
                                <li class="submenu-item"><a class="submenu-link" href="settings.html">Gérer les offres spéciales</a>
                                </li>
                            </ul>
                        </div>
                    </li>
